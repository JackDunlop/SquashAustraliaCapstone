    ...
    try {
      ...
      try {
        ...
        try {            
            ...
            const runScript = runPythonScript(res,'2dMaps.py',[mapType,jsonPath,videoFilePath,courtDataPath],courtLayout)
            return res.status(200).json({ message: `${mapType} map generation started` });        
        } catch (error) {
